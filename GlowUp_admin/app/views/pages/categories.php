...
<div class="w-full flex justify-end items-center m-10 ">
        <a class="font-bold font-serif text-pink-600 cursor-pointer underline decoration-1 ml-10 mr-20">Add categorie</a>
    </div>
<div class="m-4 grid grid-cols-3 sm:grid-cols-3 gap-4 place-items-center">
