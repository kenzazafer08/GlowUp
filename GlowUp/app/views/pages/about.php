...
<a href="<?+URLROOT?>" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-pink-700 rounded-lg hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 dark:focus:ring-pink-900">
    Learn more
